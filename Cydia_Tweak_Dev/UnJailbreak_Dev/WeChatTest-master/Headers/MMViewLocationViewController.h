...
@class AnnotationLogicController, FavDataItemWrap, MMTimer, MMUILabel, MMUIView, NSString, NSURL, NavigateLogicController, POIInfo, QMapView, UIButton, UnderLineLabel;
@protocol ViewLocationDelegate;

@interface MMViewLocationViewController : MMUIViewController <QMapViewDelegate, WCActionSheetDelegate, ILocationMgrExt, UIAlertViewDelegate, NavigateLogicControllerDelegate, IScanStreetViewMgrExt, IFavoritesExt>
{
    _Bool _canAddToFav;
