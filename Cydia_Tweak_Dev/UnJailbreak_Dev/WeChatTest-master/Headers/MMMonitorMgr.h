...
@interface MMMonitorMgr : NSObject <FPSTracerDelegate, MMUIViewControllerExt, ITimeLineViewScrollExt, IMainFrameScrollExt, IBaseMsgContentViewControllerScrollExt>
{
...
- (void)handleFrameDropTooMuchWithScene:(id)arg1;
