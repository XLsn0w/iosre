...
@class InteractionLabel, MMAdaptiveLabel, MMHeadImageView, NSString, RichTextView, UIButton, UIImageView, UILabel, UINavigationController, UIView, UrlLabel, WCDataItem, WCHighLightButton, WCTimeLineStarRatingView, WCTimeLineTagView, WCTimelineCellABTestBaseTip;
...
@interface WCTimeLineCellView : MMUIView <WCImageViewDelegate, IContactMgrExt, IStrangerContactMgrExt, ContactsPanelViewDelegate, WCActionSheetDelegate, RichTextLayoutDelegate, ILinkEventExt, UIAlertViewDelegate, ITranslateSnsMgrExt>
{
    ...
    WCTimeLineStarRatingView *_adStarRatingView;
