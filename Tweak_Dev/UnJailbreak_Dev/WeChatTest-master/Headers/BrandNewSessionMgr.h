...
@interface BrandNewSessionMgr : MMService <ISessionStorageDelegate, WXGImportMessageNotification, ISessionInfoExt, MMSessionRefreshExt, BrandTimelineMsgMgrExt, INewABTestMgrExt, MMService, IMsgExt, IContactMgrExt, IMMNewSessionMgrExt, IMMNewSessionMgrFilterExt>
{
...
- (void)updateMainSessionByDelMsgUserName:(id)arg1;
- (void)updateMainSessionWithNewBrandTimelineMsg:(id)arg1;
- (void)updateMainSessionlastMsgInfo;
