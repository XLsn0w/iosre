...
@interface MMBaseSessionCellData : NSObject
{
    ...
    _Bool _bShowUnReadAsRedNum;
    unsigned int _jumpMsgLocalId;
    NSString *m_fromBusinessNameLabel;
}

@property(nonatomic) unsigned int jumpMsgLocalId; // @synthesize jumpMsgLocalId=_jumpMsgLocalId;
@property(nonatomic) _Bool bShowUnReadAsRedNum; // @synthesize bShowUnReadAsRedNum=_bShowUnReadAsRedNum;
