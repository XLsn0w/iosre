...
#import "MMRTScrollViewDelegate-Protocol.h"
...
@class CTRichTextView, CrossfadeAnimationController, MMRichTextCoverView, MMScrollView, MMTextFloatBottomToolView, NSString, UIButton, UIFont, UIView;
@protocol ILinkEventExt, TextFloatPreviewDelegate;

@interface TextFloatViewController : MMUIViewController <TransitioningAnimationDelegate, MMRTCMenuResponderDelegate, MMTextFloatBottomToolViewDelegate, MMRTScrollViewDelegate, ILinkEventExt, scrollViewDelegate, MMRichTextSelectEventDelegate>
{
    UIView *m_oBackView;
    UIButton *m_view;
    ...
    UIButton *m_speakButton;
    UIButton *m_localSpeakButton;
