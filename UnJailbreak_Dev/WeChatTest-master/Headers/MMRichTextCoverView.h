...
@protocol MMRTScrollViewDelegate, MMRichTextCoverViewDelegate, MMRichTextSelectEventDelegate;
...
@interface MMRichTextCoverView : UIView <WCActionSheetDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate, MMRTCMenuSelectDelegate>
{
    ...
    id <MMRTScrollViewDelegate> _rtScrollDelegate;
...
@property(nonatomic) __weak id <MMRTScrollViewDelegate> rtScrollDelegate; // @synthesize rtScrollDelegate=_rtScrollDelegate;
