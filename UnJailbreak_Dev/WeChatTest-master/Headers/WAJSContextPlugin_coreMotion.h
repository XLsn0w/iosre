...
@interface WAJSContextPlugin_coreMotion : WAJSContextPluginBase <ILocationMgrExt, INetworkStatusMgrExt>
{
    ...
    _Bool _orientationChangeWorking;
    _Bool _orientationChangeBySuspend;
...
- (void)stopDeviceOrientationChangeListening:(_Bool)arg1;
- (void)enableDeviceOrientationChangeListening;
- (void)enableDeviceOrientationChangeListening:(_Bool)arg1;
