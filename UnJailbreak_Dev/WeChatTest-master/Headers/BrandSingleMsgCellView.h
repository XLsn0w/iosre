...
@class BrandSingleMsgCellViewModel, CALayer, MMHeadImageView, MMUILabel, RichTextView, UIView;

@interface BrandSingleMsgCellView : MMTableViewCell
{
    BrandSingleMsgCellViewModel *_viewModel;
...
@property(retain, nonatomic) BrandSingleMsgCellViewModel *viewModel; // @synthesize viewModel=_viewModel;
- (void).cxx_destruct;
- (void)layoutSubviews;
- (void)initSubViews;
